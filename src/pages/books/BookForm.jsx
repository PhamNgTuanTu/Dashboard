...
function BookForm(props) {
  ...
  const validationSchema = Yup.object().shape({
    ...
    weight: Yup.number()
      .positive("Vui lòng nhập số dương")
      .typeError("Vui lòng nhập dạng số")
      .min(0.0, "giá trị lớn hơn 0.00")
      .max(999.99, "giá trị nhỏ hơn 999.99")
      .required("Vui lòng nhập trường này"),
    format: Yup.string().required("Vui lòng nhập trường này"),
    release_date: Yup.number()
      ...
      .nullable(),
    language: Yup.string().required("Vui lòng nhập trường này"),
    size: Yup.string().required("Vui lòng nhập trường này"),
    num_pages: Yup.number()
      .integer("vui lòng nhập số nguyên")
      .positive("Vui lòng nhập số dương")
      .typeError("Vui lòng nhập dạng số")
      .required("Vui lòng nhập trường này"),
    category_id: Yup.number().required("Vui lòng chọn trường này").nullable(),
    author_id: Yup.number().required("Vui lòng chọn trường này").nullable(),
    publisher_id: Yup.number().required("Vui lòng chọn trường này").nullable(),
    supplier_id: Yup.number().required("Vui lòng chọn trường này").nullable(),
    front_cover: Yup.mixed().required("Vui lòng chọn hình ảnh").nullable(),
    back_cover: Yup.mixed().required("Vui lòng chọn hình ảnh").nullable(),
        ...
        return (
          <Form>
            ...
            <div className="row">
              ...
              <div className="col-6">
                <Field name="size" component={InputFieldSize} />
              </div>
            </div>
            <div className="row">
              <div className="col-6">
