...
import { addAuthor, editAuthor, removeAuthor, setDataAuthor, setLoadingData, setPageAuthor } from '../../store/author';
...
function Author(props) {
    const nameTitleInitial = 'Tác Giả';
    ...
    const onSubmit = (values, { resetForm }) => {
        ...
        if (isAddMode) {
            ...
            authorApi.editAuthorApi(values, idEdit)
                .then(response => {
                    if (response.success) {
    ...
    return (
        <>
            ...
            <section className="home-section">
                ...
                <div className='row'>
                    <div className="col-6">
                        <Search handleSearchChange={handleSearchChange} searchValue={searchValue} SearchCaption={"tác giả"} />
                    </div>
                    <div className="col-6">
                    ...
                    <div className="col-12">
                        <div className="card">
                            <div className="card-header">
                                ...
                                <button type="button" className="btn btn-primary" onClick={openModal}>Thêm Tác Giả</button>
                            </div>
            ...
            <View description={description} handelView={handelView} hideText={hideText} />
        </>
    );
}
